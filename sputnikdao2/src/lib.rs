...
pub struct Contract {
    ...
    /// 투표 스테이킹 계약 ID. 이 계약은 이 계정을 소유자로 가져야 합니다.
    ...
    /// 사용자별 바운티 청구자 맵. 각 사용자의 청구를 빠르게 조회할 수 있습니다.
...
impl Contract {
    ...
    /// 계약 저장소에서 블롭을 제거하고 원래의 저장자에게 환불합니다.
    /// 원래의 저장자만 이것을 호출할 수 있습니다.
    ...
    /// 자동 업데이트가 허용되는지 포함하여 공장 정보를 반환합니다.
