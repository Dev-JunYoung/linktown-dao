...
impl Contract {
    ...
    /// 지정된 해시가 포함된 blob을 저장할 경우 반환합니다.
    ...
    /// 사용 가능한 NEAR 금액(보관 및 채권 금액 외)을 반환합니다.
    ...
    pub fn get_proposal(&self, id: u64) -> ProposalOutput {
         // 로그에 제안 ID를 기록합니다.
        near_sdk::log!("Getting proposal with ID: {}", id);
        env::log_str("Function: myLog");
